...
public class LimitFilter implements Filter {  
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {  
        ...
        httpServletResponse.setHeader("Access-Control-Allow-Headers", "sessionid,user_id,tenant_id,call_type,User-Agent,Origin,Cache-Control,Content-type,Date,Server,withCredentials,AccessToken");  
